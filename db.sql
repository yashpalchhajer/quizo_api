...
ALTER TABLE `qa_payment_masters` ADD `reference_number_2` VARCHAR(255) NULL AFTER `reference_number_1`, ADD `reference_number_3` VARCHAR(255) NULL AFTER `reference_number_2`, ADD `reference_number_4` TEXT NULL AFTER `reference_number_3`;
