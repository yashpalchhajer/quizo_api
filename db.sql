...
INSERT INTO `qa_api_providers` (`id`, `name`, `contact_number`, `email`, `icon`, `type`, `status`, `credentials`, `createdAt`, `updatedAt`) VALUES (NULL, 'Paytm', '8098565898', 'support@paytm.com', NULL, 'PAYMENT', 'ACTIVE', '{"MID":"SySREz95222433354045","WEBSITE":"WEBSTAGING","CHANNEL_ID":"APP","INDUSTRY_TYPE_ID":"Retail","MERCHANT_KEY":"fusjs!7s0Xx80RaX","TRANSACTION_URL":"https://securegw-stage.paytm.in/theia/processTransaction","REQUERY_URL":"https://securegw-stage.paytm.in/merchant-status/getTxnStatus","CALLBACK_URL":"http://localhost:8080/paytm-call-back"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
